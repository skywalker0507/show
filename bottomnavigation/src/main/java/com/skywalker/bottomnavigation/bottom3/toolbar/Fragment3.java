package com.skywalker.bottomnavigation.bottom3.toolbar;
...
public class Fragment3 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_bottom_3_with_toolbar,container,false);
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.fragment_bottom_3_with_toolbar_recyclerView);
